<template>
  <div class="max-w-4xl mx-auto relative px-4 py-16 sm:px-6 sm:py-24 lg:py-48 lg:px-8 text-white lg:text-center">
    <!-- <div class="flex flex-col lg:flex-row lg:items-center lg:space-x-6 space-y-2 lg:space-y-0 lg:justify-center py-4">
      ...
      <div class="flex items-center space-x-3">
        <span class="h-2 w-2 bg-blue-600 rounded-full"></span> 
        <a class="text-base lg:text-[18px] lg:font-semibold hover:underline"
        href="https://www.google.com/maps/dir//IDI+Logistics,+Peachtree+Street+Northeast,+Atlanta,+GA,+USA/@33.7873076,-84.41791,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x88f5044373b39cbf:0xdca34e4a212adb67!2m2!1d-84.3828907!2d33.7872412">
          IDI Logistics
        </a>
      </div>
    </div>  -->
